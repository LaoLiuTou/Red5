...
function() {
    ...
    e.prototype.start = function() {
        ...
        t.align = "middle",
        swfobject.embedSWF("publisher.swf", this.container, this.previewWindowWidth, this.previewWindowHeight, "11.1.0", "AdobeFlashPlayerInstall.swf", e, t, i,
        function(e) {
            r.callbackObj = e
        }),
        this
   ...
   /* e.prototype.sendHeart = function(e) {
        ...
        this.preHeartUrl = e,
        i = "//" + (window.__ne_publisher_heart_server || "sdkstats.live.126.net") + "/sdkstats/report/type=1?version=1",
        r = JSON.stringify({
            push_url: e
        }),
        s.open(t, i, !0),
        ...
        s.send(r),
        this.heartTimer || (this.heartTimer = setInterval(this.sendHeart.bind(this, e), 1e4))
    },
    e.prototype.stopHeart = function() {
        ...
        if (e) {
            ...
            r = "",
            s = new XMLHttpRequest;
            i = "//" + (window.__ne_publisher_heart_server || "sdkstats.live.126.net") + "/closechannel?url=" + encodeURIComponent(e),
            s.open(t, i, !0),
            s.timeout = 1e4,
            s.setRequestHeader("Content-type", "application/json;charset=UTF-8"),
            s.send(r)
    ...
    /*e.prototype.fetchCdnUrl = function(e, t) {
       function i() {
            ...
            i = i.indexOf("?") === -1 ? i + "?get_url=3": i + "&get_url=3",
            s.open("GET", i, !0),
            s.timeout = 2e3,
    ...
    e.prototype.fetchGslbUrl = function(e) {
        ...
        i = this.tryNeteaseGslb ? "gslbhz.live.126.net": "gslb.live.126.net"; (window.__ne_publisher_gslb_server || window.__ne_publisher_gslb_server_tencent || window.__ne_publisher_gslb_server_netease) && (i = this.tryNeteaseGslb ? window.__ne_publisher_gslb_server_netease || window.__ne_publisher_gslb_server || i: window.__ne_publisher_gslb_server_tencent || window.__ne_publisher_gslb_server || i);
        var r = "//" + i + "/getpushurl";
        t.open("POST", r),
        t.timeout = 2e3,
    ...
    e.prototype.tryFindBestUrl = function() {
        ...
        case 0:
            if (this.gslbUrlArr) {
                ...
                return this.urlTryState++,
                this.tryFindBestUrl()
            }
            this.fetchGslbUrl(function(e, t, i) {
                return e ? (this.urlCdnType = t, this.gslbUrlArr = e, this.urlCdnResolved = i) : this.tryNeteaseGslb ? (this.urlCdnType = t, this.urlTryState++) : this.tryNeteaseGslb = !0,
                this.tryFindBestUrl()
            }.bind(this));
            break;
        case 1:
            if (!this.urlCdnType || this.urlCdnResolved) return this.urlTryState++,
            this.tryFindBestUrl();
            this.fetchCdnUrl(this.urlCdnType,
            function(e) {
        ...
        case 2:
            return this.urlTryState++,
            this.callbackObj.ref.__publish(this.url, this.vcodec, this.acodec);
        case 3:
            var t = 104;
            this.code = t,
            this.on_publisher_error(t, this.errors["" + t])
        }
    },*/
    e.prototype.doPublish = function() {
    	 
        this.urlTryState = 2,
        this.gslbUrlArr = null,
        this.urlCdnType = null,
        this.urlCdnResolved = null,
        this.tryNeteaseGslb = !1,
        //this.fetchGslbUrlXhr && (this.fetchGslbUrlXhr.abort(), this.fetchGslbUrlXhr = null),
        //this.fetchCdnUrlXhr && (this.fetchCdnUrlXhr.abort(), this.fetchCdnUrlXhr = null),
        //this.tryFindBestUrl()
        this.callbackObj.ref.__publish(this.url, this.vcodec, this.acodec);
    },
    e.prototype.startPublish = function() {
        ...
        /*"" === this.url ? e.js_bridge_message("error", '{"id":' + this.id + ',"code":110}') : 
        	this.url.indexOf("live.126.net") == -1 || 
        	this.url.indexOf("rtmp://p") == -1 ? e.js_bridge_message("error", {
            id: this.id,
            code: 105
        }) : */
        	void this.doPublish()
    ...
    e.prototype.stopPublish = function(e) {
        //e || this.stopHeart(),
        this.callbackObj.ref.__stop_publish()
    },
    ...
    e.prototype.getCameraSnapshot = function(e, t) {
        ...
        this.callbackObj.ref.__getCameraShapshot(t)
    },
...
var swfobject = function() {
    ...
    function n() {
        ...
        if (e > 0) for (var t = 0; t < e; t++) {
            ...
            if (q.pv[0] > 0) {
                var n = v(i);
                if (n) if (!w(M[t].swfVersion) || q.wk && q.wk < 312) if (M[t].expressInstall && a()) {
                    var c = {};
                    c.data = M[t].expressInstall,
                    c.width = n.getAttribute("width") || "0",
                    c.height = n.getAttribute("height") || "0",
                    n.getAttribute("class") && (c.styleclass = n.getAttribute("class")),
                    n.getAttribute("align") && (c.align = n.getAttribute("align"));
                    for (var u = {},
                    d = n.getElementsByTagName("param"), p = d.length, f = 0; f < p; f++)"movie" != d[f].getAttribute("name").toLowerCase() && (u[d[f].getAttribute("name")] = d[f].getAttribute("value"));
                    l(c, u, i, r)
                } else h(n),
                r && r(s);
                else _(i, !0),
                r && (s.success = !0, s.ref = o(i), r(s))
            } else if (_(i, !0), r) {
                var b = o(i);
                b && typeof b.SetVariable != E && (s.success = !0, s.ref = b),
                r(s)
            }
        }
    }
    function o(e) {
        var t = null,
        i = v(e);
        if (i && "OBJECT" == i.nodeName) if (typeof i.SetVariable != E) t = i;
        else {
    ...
    function l(e, t, i, r) {
        ...
        var s = v(i);
        if (s) {
            "OBJECT" == s.nodeName ? (C = c(s), S = null) : (C = s, S = i),
            e.id = L,
    ...
    function c(e) {
        ...
        if (q.win && q.ie) t.innerHTML = e.innerHTML;
            ...
            if (i) {
                ...
                n = 0; n < s; n++) 1 == r[n].nodeType && "PARAM" == r[n].nodeName || 8 == r[n].nodeType || t.appendChild(r[n].cloneNode(!0))
            }
        }
        return t
    }
    function u(e, t, i) {
        ...
        if (s) if (typeof e.id == E && (e.id = i), q.ie && q.win) {
            var n = "";
            ...
            s.outerHTML = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"' + n + ">" + a + "</object>",
            R[R.length] = e.id,
            r = v(e.id)
        } else {
            var h = b(N);
    ...
    function p(e) {
        var t = v(e);
        t && "OBJECT" == t.nodeName && (q.ie && q.win ? (t.style.display = "none",
        function() {
        ...
        if (!q.ie || !q.mac) {
            ...
            if (s) {
                ...
                if (r && (P = null, j = null), !P || j != n) {
                    ...
                    P = s.appendChild(o),
                    q.ie && q.win && typeof x.styleSheets != E && x.styleSheets.length > 0 && (P = x.styleSheets[x.styleSheets.length - 1]),
                    j = n
                }
    ...
    q = function() {
        ...
        a = [0, 0, 0],
        l = null;
        if (typeof W.plugins != E && typeof W.plugins[O] == N) l = W.plugins[O].description,
        !l || typeof W.mimeTypes != E && W.mimeTypes[A] && !W.mimeTypes[A].enabledPlugin || (H = !0, o = !1, l = l.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), a[0] = parseInt(l.replace(/^(.*)\..*$/, "$1"), 10), a[1] = parseInt(l.replace(/^.*\.(.*)\s.*$/, "$1"), 10), a[2] = /[a-zA-Z]/.test(l) ? parseInt(l.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0);
        ...
        q.w3 && ((typeof x.readyState != E && "complete" == x.readyState || typeof x.readyState == E && (x.getElementsByTagName("body")[0] || x.body)) && e(), V || (typeof x.addEventListener != E && x.addEventListener("DOMContentLoaded", e, !1), q.ie && q.win && (x.attachEvent(U,
        function() {
    ...
    function() {
        q.ie && q.win && window.attachEvent("onunload",
        function() {
            for (var e = G.length,
    ...
    return {
        ...
        embedSWF: function(e, i, r, s, n, o, h, c, d, p) {
            ...
            q.w3 && !(q.wk && q.wk < 312) && e && i && r && s && n ? (_(i, !1), t(function() {
                ...
                s += "";
                var t = {};
                if (d && typeof d === N) for (var v in d) t[v] = d[v];
                t.data = e,
                t.width = r,
                t.height = s;
                var b = {};
                if (c && typeof c === N) for (var y in c) b[y] = c[y];
                if (h && typeof h === N) for (var m in h) typeof b.flashvars != E ? b.flashvars += "&" + m + "=" + h[m] : b.flashvars = m + "=" + h[m];
                if (w(n)) {
                    var g = u(t, b, i);
                    t.id == i && _(i, !0),
                    f.success = !0,
        ...
        getQueryParamValue: function(e) {
            ...
            if (t) {
                ...
                for (var i = t.split("&"), r = 0; r < i.length; r++) if (i[r].substring(0, i[r].indexOf("=")) == e) return g(i[r].substring(i[r].indexOf("=") + 1))
            }
            return ""
        },
        expressInstallCallback: function() {
            if ($) {
                var e = v(L);
                e && C && (e.parentNode.replaceChild(C, e), S && (_(S, !0), q.ie && q.win && (C.style.display = "block")), k && k(T)),
                $ = !1
            }
        }
    }
